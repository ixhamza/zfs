...
zfs_prop_init(void)
{
	...
	zprop_register_number(ZFS_PROP_DEFAULTPROJECTQUOTA,
	    "defaultprojectquota", 0, PROP_DEFAULT, ZFS_TYPE_FILESYSTEM,
	    "<size> | none", "DEFAULTPROJECTQUOTA", B_FALSE, sfeatures);
	zprop_register_number(ZFS_PROP_DEFAULTUSEROBJQUOTA,
	    "defaultuserobjquota", 0, PROP_DEFAULT, ZFS_TYPE_FILESYSTEM,
	    "<size> | none", "DEFAULTUSEROBJQUOTA", B_FALSE, sfeatures);
	zprop_register_number(ZFS_PROP_DEFAULTGROUPOBJQUOTA,
	    "defaultgroupobjquota", 0, PROP_DEFAULT, ZFS_TYPE_FILESYSTEM,
	    "<size> | none", "DEFAULTGROUPOBJQUOTA", B_FALSE, sfeatures);
	zprop_register_number(ZFS_PROP_DEFAULTPROJECTOBJQUOTA,
	    "defaultprojectobjquota", 0, PROP_DEFAULT, ZFS_TYPE_FILESYSTEM,
	    "<size> | none", "DEFAULTPROJECTOBJQUOTA", B_FALSE, sfeatures);
